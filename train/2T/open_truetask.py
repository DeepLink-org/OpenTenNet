...
cont_file = 'TensorNetwork/sc38_reproduce_scheme_n53_m20_ABCDCDAB_3000000_einsum_10_open.pt'
nsch = torch.load(f'TensorNetwork/open_sc38_nsch_split{split}_mg{mgmodes}_splitmn.pt')
...
if args.data_type == 0:
    ...
    # TODO: 现在用8节点做2T关联子空间只是权宜之计，如果有可能，还是把他取消了
    if nodes_per_task <= 4:
