...
nsch = torch.load(f'TensorNetwork/sc38_nsch_split{split}_mg{mgmodes}_splitmn.pt')
...
benckmark = f"results/benchmark/{args.tensorNetSize}/ntask{ntask*subtasks-1}.pt"
...
if world_rank == 0:
    print(f"fidelity of task {ntask*subtasks-1}: {round(fidelity, 6)}", flush = True)
