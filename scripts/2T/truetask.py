...
if world_rank == 0:
    ...
    print(f"Truetask used {round(total_time[0].item(), 3)} s, communication used {round(com_time, 2)}s, calculation used {round(time_end-time_begin-com_time, 2)}s", flush = True)
