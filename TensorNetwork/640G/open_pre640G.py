...
# %%
scheme = torch.load('TensorNetwork/reproduce_scheme_n53_m20_ABCDCDAB_3000000_einsum_10_open.pt')
...
# %%
import torch
torch.save(nsch,f'TensorNetwork/640G_rep_nsch640_split{split}_mg{mgmodes}_splitmn.pt')
