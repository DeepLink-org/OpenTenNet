...
# --ntask 2 --tensorNetSize 2T --typeCom int8kernel
...
--ntasks-per-node=${ntasks_per_node} \
--gres=gpu:${ntasks_per_node} \
python train/640G/truetask.py \
--job_select 0 --warmup 1 --data_type 1 --is_scale 0 --autotune 1 \
--ntask 1 --tensorNetSize 640G --typeCom complex64